                ...
                <div class="p-6">
                  <form class="space-y-4" id="sending_form">
                      ...
                      <div class="input-area relative">
                        ...
                        <div class="relative">
                          <input type="text" name="code" class="form-control !pl-9" placeholder="kode Schedule">
                        ...
                        <span class="mt-2 text-danger-500 hidden text-sm err">username is a required field</span>
                      </div>
            ...
            .done(function(msg){
              if(msg.stsCode == 422){
                ...
                $.each( msg.message, function( key, value ) {
                  $(`[name="${key}"]`).parent().parent().find('span.err').html(value);
                  $(`[name="${key}"]`).parent().parent().find('span.err').addClass('error')
                });
              }else{
                Swal.fire({
                  title: 'success',
