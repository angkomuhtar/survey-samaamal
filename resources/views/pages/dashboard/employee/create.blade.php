            ...
            <div class="card-body p-6">
                ...
                <form class="wizard-form mt-10" action="#">
                    <div class="wizard-form-step active" data-step="1">
                        <div class="grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 gap-5">
                            ...
                            <div class="input-area">
                                ...
                                <input id="password" type="password" name="password" class="form-control" placeholder="type your password" required="required">
                                <div class="font-Inter text-sm text-danger-500 pt-2 error-message" style="display: none">This is invalid state.</div>
                            </div>
                            <div class="input-area">
                                <label for="password_confirmation" class="form-label">Confirm Password</label>
                                <input id="password_confirmation" type="password" name="password_confirmation" class="form-control" placeholder="Re-type your password" required="required">
                                <div class="font-Inter text-sm text-danger-500 pt-2 error-message" style="display: none">This is invalid state.</div>
                            </div>
                    ...
                    <div class="wizard-form-step" data-step="2">
                        <div class="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-5">
                            ...
                            <div class="input-area">
                                ...
                                <input id="card_id" type="text" name="card_id" class="form-control" placeholder="No. Kartu Identitas" required="required">
                                <div class="font-Inter text-sm text-danger-500 pt-2 error-message" style="display: none">This is invalid state.</div>
                            </div>
                            <div class="input-area">
                                <label for="kk" class="form-label">Kartu keluarga</label>
                                <input id="kk" type="text" name="kk" class="form-control" placeholder="No. Kartu keluarga" required="required">
                                <div class="font-Inter text-sm text-danger-500 pt-2 error-message" style="display: none">This is invalid state.</div>
                            </div>
                            <div class="input-area">
                                <label for="tmp_lahir" class="form-label">tempat lahir</label>
                                <input id="tmp_lahir" type="text" name="tmp_lahir" class="form-control" placeholder="Tempat Lahir" required="required">
                                <div class="font-Inter text-sm text-danger-500 pt-2 error-message" style="display: none">This is invalid state.</div>
                            </div>
                            <div class="input-area">
                                <label for="tgl_lahir" class="form-label">Tanggal Lahir</label>
                                <input class="form-control py-2 flatpickr flatpickr-input active" name="tgl_lahir" id="default-picker" value="" type="text" readonly="readonly">
                            ...
                            <div class="input-area">
                                ...
                                <select id="education" class="form-control" name="education">
                                    ...
                                    @foreach ($education as $item)
                                        <option value="{{$item->id}}" class="dark:bg-slate-700">{{$item->value}}</option>
                                    @endforeach
                                </select>
                                <div class="font-Inter text-sm text-danger-500 pt-2 error-message" style="display: none">This is invalid state.</div>
                            </div>
                            ...
                            <div class="input-area">
                                ...
                                <select id="marriage" class="form-control" name="marriage">
                                    ...
                                    @foreach ($marriage as $item)
                                        <option value="{{$item->id}}" class="dark:bg-slate-700">{{$item->value}} ({{$item->kode}})</option>
                                    @endforeach
                                </select>
                                <div class="font-Inter text-sm text-danger-500 pt-2 error-message" style="display: none">This is invalid state.</div>
                            </div>
                            ...
                            <div class="input-area">
                                ...
                                <textarea id="live_addr" rows="5" name="live_addr" class="form-control" placeholder="Alamat Sesuai Seusai domisili sekarang"></textarea>
                                <div class="font-Inter text-sm text-danger-500 pt-2 error-message" style="display: none">This is invalid state.</div>
                            </div>
                        </div>
                    </div>
                    <div class="wizard-form-step" data-step="3">
                        <div class="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-5">
                            ...
                            <div class="input-area">
                                ...
                                <input class="form-control py-2 flatpickr flatpickr-input active" name="doh" id="default-picker" value="" type="text" readonly="readonly">
                                <div class="font-Inter text-sm text-danger-500 pt-2 error-message" style="display: none">This is invalid state.</div>
                            </div>
                            <div class="input-area">
                    ...
                    <div class="mt-6 space-x-3 flex justify-end">
                        <button class="btn btn-dark prev-button" style="display: none" type="button">Sebelumnya</button>
            ...
            $(() => {
                ...
                $(document).on('change', 'select[name="division_id"]', (e)=>{
                    ...
                    $.ajax({
                        ...
                        if (res.data.length > 0) {
                            res.data.map((data)=>{
                            dataOption += `<option value="${data.id}" class="dark:bg-slate-700">${data.position}</option>`
                            })
                        }
                        $('select[name="position_id"]').html(dataOption)
                        },
