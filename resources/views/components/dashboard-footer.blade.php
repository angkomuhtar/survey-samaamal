...
<footer id="footer">
    <div class="site-footer px-6 bg-white dark:bg-slate-800 text-slate-500 dark:text-slate-300 py-4 ltr:ml-[248px] rtl:mr-[248px]">
        ...
        <div class="text-center ltr:md:text-start rtl:md:text-right text-sm">
            {{ __('COPYRIGHT') }} © <script>  document.write(new Date().getFullYear())</script> {{ __('PT. Mitra Abadi Mahakam, All rights Reserved') }}
        </div>
        <div class="ltr:md:text-right rtl:md:text-end text-center text-sm flex justify-end">
            {{ __('Design & Develop by') }}
            <a href="https://angco.id" target="_blank" class="text-primary-500 font-semibold ml-2">
