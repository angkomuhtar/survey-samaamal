<form method="POST" action="{{ route('authenticate') }}" class="space-y-4">
    ...
    {{-- Email --}}
    <div class="fromGroup">
        <label for="email" class="block capitalize form-label">{{ __('Email or Username') }}</label>
        <div class="relative ">
    ...
    <div class="fromGroup">
        ...
        <div class="relative ">
            <input type="password" value="{{ old('password') }}" name="password" class="form-control py-2 @error('password') !border !border-red-500 @enderror" placeholder="{{ __('Password') }}" id="password" autocomplete="current-password">
